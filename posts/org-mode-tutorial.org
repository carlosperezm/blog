...
#+CAPTION: This is a table with lines around and between cells
#+ATTR_HTML: :border 2 :rules group :frame border 0 :class table table-striped table-hover
| ID |     x |   y | comments |
|----+-------+-----+----------|
|  1 |    24 |   6 | first    |
|  2 |    64 |  24 | second   |
...
#+ATTR_HTML: :border 3 :rules groups :frame border 0 :class table table-striped table-hover
| ID  |  x |  y | Mean |
|-----+----+----+------|
| A   |  9 |  4 |  6.5 |
| B   |  5 |  4 |  4.5 |
...
#+RESULTS:
:RESULTS:
: [<matplotlib.lines.Line2D at 0x7f56e875a780>]
